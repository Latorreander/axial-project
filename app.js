...
const refContent = document.querySelector(".ref");
...
saveBtn.addEventListener("click", () => {
    ...
    arrReferences.forEach((item) => {
        refContent.innerHTML = `<span><strong>${item.Reference}  »»»»  ${item.Quantity}Pçs</strong></span>`;
    });
...
//     arrReferences.forEach((item) => {
//         refContent.innerHTML = `<span>${item.Reference} »»»» ${item.Quantity}</span>`;
//     });
